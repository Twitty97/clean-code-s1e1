...
var taskInput=document.querySelector(".section__input--new-task"); // Add a new task.
var addButton=document.querySelector(".section__btn"); // select the button
var incompleteTaskHolder=document.querySelector(".section__list--incomplete-tasks"); // ul of #incomplete-tasks
var completedTasksHolder=document.querySelector(".section__list--completed-tasks"); // completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    label.className='section__task section__label';
    ...
    editInput.type="text";
    editInput.className="section__input section__input--text section__input--task section__task";
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("section__list-item--edit");
    ...
    listItem.classList.toggle("section__list-item--edit");
};
